...
--Create relaationship between 'classification' and 'inventory' tables
...
VALUES   (
  ...
  --update description for the hummer to be more accurate and update the image paths for all inventory items
UPDATE inventory
